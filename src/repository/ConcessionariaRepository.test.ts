...
describe('Repositório ConcessionariaRepository', () => {
    ...
    describe('Método salvar', () => {
        it('deve chamar o prisma.concessionaria.create com os dados corretos', async () => {
            // Arrange
            const novaConcessionaria = new Concessionaria('Auto Center', '12.345.678/0001-99', 'São Paulo');
            const retornoDoBanco = { id: 1, nome: 'Auto Center', cnpj: '12.345.678/0001-99', cidade: 'São Paulo' };
            ...
            expect(prisma.concessionaria.create).toHaveBeenCalledWith({
                data: { nome: 'Auto Center', cnpj: '12.345.678/0001-99', cidade: 'São Paulo' }
            });
    ...
    describe('Método buscarPorId', () => {
        it('deve retornar uma nova instância de Concessionaria se encontrar no banco', async () => {
            // Arrange
            const concessionariaNoBanco = { id: 10, nome: 'Veloz Motors', cnpj: '98.765.432/0001-11', cidade: 'Curitiba' };
            ...
            expect(resultado?.nome).toBe('Veloz Motors');
        });
